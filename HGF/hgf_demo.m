...
disp(est.traj)
%% Enhanced HGF
% The enhanced HGF (eHGF) is based on a more carefully reasoned derivation of 
% the update equations. As a result, it allows for a much greater range of parameter 
% values and associated belief trajectories and behaviours. For example, using 
% the parameter values below leads to an error in the classic HGF, while the eHGF 
