function [y] = tapas_mpdcm_fmri_int_cuda(u, theta, ptheta, sloppy)
...
if isfield(ptheta, 'integ')
    ...
    case 'rk4'
        if theta{1}.fD
            integ = @(u, theta, ptheta) c_mpdcm_fmri_std_rk4_nonlinear(u, ...
                theta, ptheta);
        else 
            integ = @(u, theta, ptheta) c_mpdcm_fmri_std_rk4_bilinear(u, ...
                theta, ptheta);
        end
    end
else
