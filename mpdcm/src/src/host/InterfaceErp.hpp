...
#ifndef INTERFACEERP_H
#define INTERFACEERP_H
...
class InterfaceErp : public InterfaceHost
{
    public:
...
template < class T_Integrator >
std::vector< arma::Mat< double > > 
InterfaceErp< T_Integrator >::init_y(const mxArray *u, const mxArray *theta, 
    const mxArray *ptheta)
{
...
template < class T_Integrator >
int
InterfaceErp< T_Integrator>::integrate(
