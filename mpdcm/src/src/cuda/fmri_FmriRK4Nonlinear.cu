...
__device__
FmriRK4Nonlinear::FmriRK4Nonlinear() : FmriCuda(DIM_FMRI_X, PRELOC_SIZE_FMRI_RK4_X)
{

}

__device__
int FmriRK4Nonlinear::update_x(dbuff *ox, dbuff *y, dbuff *u, dbuff *nx)
{
    ...
    fmri_dNonlinear(nx, y, tu, theta, ptheta, j, dxacc);
