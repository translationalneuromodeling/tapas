...
__device__
FmriStandardRK4Bilinear::FmriStandardRK4Bilinear() : FmriCuda(DIM_FMRI_X, 4)
{

}

__device__
int FmriStandardRK4Bilinear::update_x(dbuff *ox, dbuff *y, dbuff *u, dbuff *nx)
{
    ...
    fmri_dL(k2, y, tu, theta, ptheta, j, dxacc);
