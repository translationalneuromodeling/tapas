function [posterior] = tapas_sem_mixed_estimate(data, model, inference, pars)
...
[model] = tapas_sem_mixed_model(data, model, pars);
[inference] = tapas_sem_mixed_inference(inference, pars);
