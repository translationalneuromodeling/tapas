...
matlabbatch{1}.spm.tools.physio.log_files.cardiac = {'sub-control01_task-YOURTASK_run-1_desc-sync_physio.tsv.gz'};
matlabbatch{1}.spm.tools.physio.log_files.respiration = {'sub-control01_task-YOURTASK_run-1_desc-sync_physio.tsv.gz'};
