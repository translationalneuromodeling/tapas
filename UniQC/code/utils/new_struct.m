function new_struct(varargin)
% Creates a new script (e.g. tests/examples) including header.
%   new_struct(funname) opens the editor and pastes the content
%   of a user-defined template into the file funname.m.
% 
%   Example
%       new_struct myscript
%           OR 
%       new_struct myscript author
%
...
% Modified: 2019-01-05 (Saskia Bollmann and Lars Kasper)	
	...
	switch nargin
		case 0
			edit
			warning('new_struct without argument is the same as edit')
			return;
		case 1
			fname=varargin{:};
