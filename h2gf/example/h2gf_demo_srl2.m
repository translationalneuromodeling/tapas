...
% =========================================================================
% h2gf_demo_srl2(1,4000,1,1)
% =========================================================================

function h2gf_demo_srl2(m,NrIter,spec_eta,config_file)
...
cd (maskResFolder);
save(['h2gf_3l_est_srl2_',configtype,'_eta',eta_label,'_', num2str(NrIter),'_',num2str(m),'.mat'],'-struct','h2gf_est_srl2');
clear h2gf_est_srl2;
end