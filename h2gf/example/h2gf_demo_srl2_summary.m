...
saveas(gcf,['h2gf_LME_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'fig');
print(['h2gf_LME_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'-dtiff');
...
saveas(gcf,['h2gf_ka_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'fig');
print(['h2gf_ka_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'-dtiff');
...
saveas(gcf,['h2gf_om2_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'fig');
print(['h2gf_om2_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'-dtiff');
...
saveas(gcf,['h2gf_om3_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'fig');
print(['h2gf_om3_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'-dtiff');
...
saveas(gcf,['h2gf_mu2_0_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'fig');
print(['h2gf_mu2_0_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'-dtiff');
...
plot([0 length(options.subjectIDs)+1],[mean_ze mean_ze],'black');
plot([0 length(options.subjectIDs)+1],[h2gf_inf.hgf.c_prc.priormus(prior_index,1) h2gf_inf.hgf.c_prc.priormus(prior_index,1)],'r');
axis([0 length(options.subjectIDs)+1 y1 y2])
title({['h2gf ze']; ['(mean: ', num2str(mean_ze),'; std: ', num2str(std_ze),')']});
saveas(gcf,['h2gf_ze_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'fig');
print(['h2gf_ze_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'-dtiff');
% close all;
end
