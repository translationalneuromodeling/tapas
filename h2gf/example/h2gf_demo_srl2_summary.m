...
function h2gf_demo_srl2_summary(NrIter,spec_eta,config_file)
...
cd(maskResFolder);
% listFiles=dir('*h2gf_3l_fixom_est_srl2*');
...
for m = 1:12 %length(listFiles)
    ...
    h2gf_inf = load([maskResFolder, '/h2gf_3l_est_srl2_',configtype,'_eta',eta_label,'_', num2str(NrIter),'_',num2str(m),'.mat']);
    ...
    for s = 1:length(h2gf_inf.summary)
        ...
        srl2_estpar_h2gf.param.mu2_0 = srl2_estpar_h2gf.param.p_prc.mu_0(1,2);
        srl2_estpar_h2gf.param.mu3_0 = srl2_estpar_h2gf.param.p_prc.mu_0(1,3);
        srl2_estpar_h2gf.param.sa2_0 = srl2_estpar_h2gf.param.p_prc.sa_0(1,2);
        srl2_estpar_h2gf.param.sa3_0 = srl2_estpar_h2gf.param.p_prc.sa_0(1,3);
        
        srl2_estpar_h2gf.param.ka = srl2_estpar_h2gf.param.p_prc.ka(1,2);
        srl2_estpar_h2gf.param.om2 = srl2_estpar_h2gf.param.p_prc.om(1,2);
        srl2_estpar_h2gf.param.om3 = srl2_estpar_h2gf.param.p_prc.om(1,3);
        ...
        AllInv_srl2_h2gf.mu2_0(s,m)  = srl2_estpar_h2gf.param.mu2_0;
        AllInv_srl2_h2gf.mu3_0(s,m) = srl2_estpar_h2gf.param.mu3_0;
        AllInv_srl2_h2gf.sa2_0(s,m) = srl2_estpar_h2gf.param.sa2_0;
        AllInv_srl2_h2gf.sa3_0(s,m) = srl2_estpar_h2gf.param.sa3_0;
        
        AllInv_srl2_h2gf.ka(s,m)  = srl2_estpar_h2gf.param.ka;
        AllInv_srl2_h2gf.om2(s,m) = srl2_estpar_h2gf.param.om2;
        AllInv_srl2_h2gf.om3(s,m) = srl2_estpar_h2gf.param.om3;
        AllInv_srl2_h2gf.ze(s,m) = srl2_estpar_h2gf.param.ze;
        
        save (['AllInv_srl2_h2gf_',configtype,'_eta',eta_label,'_', num2str(NrIter),'.mat'], '-struct','AllInv_srl2_h2gf');
...
boxplot(box_input,'colors',col_input, 'Plotstyle','compact'); hold on;
[i,j]=(max(median(box_input(:,1:length(box_input(1,:))))));
mean_ka= mean2(AllInv_srl2_h2gf.ka);
std_ka = std2(AllInv_srl2_h2gf.ka);
...
saveas(gcf,['srl2_h2gf_ka_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'fig');
print(['srl2_h2gf_ka_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'-dtiff');


%%omega2
figure('Color',[1 1 1]); hold on;
box_input = AllInv_srl2_h2gf.om2';
prior_index = 13;
col_input = [0.4 0.0 0.6; 0.4 0.2 0.6; 0.4 0.4 0.6; 0.4 0.6 0.6; 0.4 0.8 0.6; 0.4 1.0 0.6; ...
            1.0 1.0 0.6; 1.0 0.8 0.6; 1.0 0.6 0.6; 1.0 0.4 0.6; 1.0 0.2 0.6; 0.8 0.4 0.6; ...
            0.8 0.0 0.6];
boxplot(box_input,'colors',col_input, 'Plotstyle','compact'); hold on;
[i,j]=(max(median(box_input(:,1:length(box_input(1,:))))));
mean_om2= mean2(AllInv_srl2_h2gf.om2);
std_om2 = std2(AllInv_srl2_h2gf.om2);
...
saveas(gcf,['srl2_h2gf_om2_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'fig');
print(['srl2_h2gf_om2_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'-dtiff');

%%omega3
figure('Color',[1 1 1]); hold on;
box_input = AllInv_srl2_h2gf.om3';
prior_index = 14;
...
boxplot(box_input,'colors',col_input, 'Plotstyle','compact'); hold on;
[i,j]=(max(median(box_input(:,1:length(box_input(1,:))))));
mean_om3= mean2(AllInv_srl2_h2gf.om3);
std_om3 = std2(AllInv_srl2_h2gf.om3);
plot([0 length(h2gf_inf.summary)+1],[mean_om3 mean_om3],'black');hold on;
plot([0 length(h2gf_inf.summary)+1],[h2gf_inf.hgf.c_prc.priormus(prior_index,1) h2gf_inf.hgf.c_prc.priormus(prior_index,1)],'r');
axis([0 length(h2gf_inf.summary)+1 y1 y2])
title({['h2gf om3']; ['(mean: ', num2str(mean_om3),'; std: ', num2str(std_om3),')']});
saveas(gcf,['srl2_h2gf_om3_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'fig');
print(['srl2_h2gf_om3_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'-dtiff');

%%mu2_0
figure('Color',[1 1 1]); hold on;
box_input = AllInv_srl2_h2gf.mu2_0';
prior_index = 2;
if h2gf_inf.hgf.c_prc.priormus(prior_index,1)>min(box_input(:))
    y1 = min(box_input(:))-0.2;
else
...
boxplot(box_input,'colors',col_input, 'Plotstyle','compact'); hold on;
[i,j]=(max(median(box_input(:,1:length(box_input(1,:))))));
mean_mu2_0= mean2(AllInv_srl2_h2gf.mu2_0);
std_mu2_0 = std2(AllInv_srl2_h2gf.mu2_0);
...
saveas(gcf,['srl2_h2gf_mu2_0_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'fig');
print(['srl2_h2gf_mu2_0_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'-dtiff');


%%mu3_0
figure('Color',[1 1 1]); hold on;
box_input = AllInv_srl2_h2gf.mu3_0';
prior_index = 3;
col_input = [0.4 0.0 0.6; 0.4 0.2 0.6; 0.4 0.4 0.6; 0.4 0.6 0.6; 0.4 0.8 0.6; 0.4 1.0 0.6; ...
            1.0 1.0 0.6; 1.0 0.8 0.6; 1.0 0.6 0.6; 1.0 0.4 0.6; 1.0 0.2 0.6; 0.8 0.4 0.6; ...
            0.8 0.0 0.6];
boxplot(box_input,'colors',col_input, 'Plotstyle','compact'); hold on;
[i,j]=(max(median(box_input(:,1:length(box_input(1,:))))));
mean_mu3_0= mean2(AllInv_srl2_h2gf.mu3_0);
std_mu3_0 = std2(AllInv_srl2_h2gf.mu3_0);
...
saveas(gcf,['srl2_h2gf_mu3_0_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'fig');
print(['srl2_h2gf_mu3_0_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'-dtiff');


%%sa2_0
figure('Color',[1 1 1]); hold on;
box_input = AllInv_srl2_h2gf.sa2_0';
prior_index = 5;
if exp(h2gf_inf.hgf.c_prc.priormus(prior_index,1))>min(box_input(:))
    y1 = min(box_input(:))-0.2;
else
...
boxplot(box_input,'colors',col_input, 'Plotstyle','compact'); hold on;
[i,j]=(max(median(box_input(:,1:length(box_input(1,:))))));
mean_sa2_0= mean2(AllInv_srl2_h2gf.sa2_0);
std_sa2_0 = std2(AllInv_srl2_h2gf.sa2_0);
...
saveas(gcf,['srl2_h2gf_sa2_0_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'fig');
print(['srl2_h2gf_sa2_0_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'-dtiff');


%%sa3_0
figure('Color',[1 1 1]); hold on;
box_input = AllInv_srl2_h2gf.sa3_0';
prior_index = 6;
if exp(h2gf_inf.hgf.c_prc.priormus(prior_index,1))>min(box_input(:))
    y1 = min(box_input(:))-0.2;
else
...
boxplot(box_input,'colors',col_input, 'Plotstyle','compact'); hold on;
[i,j]=(max(median(box_input(:,1:length(box_input(1,:))))));
mean_sa3_0= mean2(AllInv_srl2_h2gf.sa3_0);
std_sa3_0 = std2(AllInv_srl2_h2gf.sa3_0);
...
saveas(gcf,['srl2_h2gf_sa3_0_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'fig');
print(['srl2_h2gf_sa3_0_boxplot_',configtype,'_eta',eta_label,'_', num2str(NrIter)],'-dtiff');
