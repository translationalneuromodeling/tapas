...
function h2gf_demo_srl1_stats_plot(config_file)
...
for e = 1:6 %length(listFiles)
    for m = 1:4
        % Find data:
        All_h2gf(e).eta(m).samples    = load(fullfile([maskResFolder,'/',configtype,'/eta', num2str(e),'/', maskSamples{m},'/AllInv_srl1_h2gf_',configtype,'_eta',num2str(e),'_',maskSamples{m},'.mat']));
    end
end

All_hgf   = load(fullfile([maskResFolder,'/hgf/',configtype,'/hgf_3l_est_srl1_summary',configtype,'.mat']));
...
mean_ka = [mean(All_h2gf(1).eta(1).samples.ka(:,1));mean(All_h2gf(2).eta(1).samples.ka(:,1)); mean(All_h2gf(3).eta(1).samples.ka(:,1)); ...
    ...
    mean(All_hgf.hgf_est_srl1_summary.ka)];
ste_ka = [std(All_h2gf(1).eta(1).samples.ka(:,1))/sqrt(length(All_h2gf(1).eta(1).samples.ka)); ...
    ...
    std(All_hgf.hgf_est_srl1_summary.ka)/sqrt(length(All_hgf.hgf_est_srl1_summary.ka));];
...
saveas(gcf,['srl1_stats_ka_',configtype],'fig');
print(['srl1_stats_ka_',configtype],'-dtiff');
...
mean_mu2_0 = [mean(All_h2gf(1).eta(1).samples.mu2_0(:,1));mean(All_h2gf(2).eta(1).samples.mu2_0(:,1)); mean(All_h2gf(3).eta(1).samples.mu2_0(:,1)); ...
    ...
    mean(All_hgf.hgf_est_srl1_summary.mu2_0)];
ste_mu2_0 = [std(All_h2gf(1).eta(1).samples.mu2_0(:,1))/sqrt(length(All_h2gf(1).eta(1).samples.mu2_0)); ...
    ...
    std(All_hgf.hgf_est_srl1_summary.mu2_0)/sqrt(length(All_hgf.hgf_est_srl1_summary.mu2_0));];
...
% Output the table using the annotation command.
annotation(gcf,'Textbox','String',TString,'Interpreter','Tex','FontName',FixedWidth,'Units','Normalized','Position',[0 0 1 1]);
saveas(gcf,['srl1_stats_mu2_0_',configtype],'fig');
print(['srl1_stats_mu2_0_',configtype],'-dtiff');
...
mean_mu3_0 = [mean(All_h2gf(1).eta(1).samples.mu3_0(:,1));mean(All_h2gf(2).eta(1).samples.mu3_0(:,1)); mean(All_h2gf(3).eta(1).samples.mu3_0(:,1)); ...
    ...
    mean(All_hgf.hgf_est_srl1_summary.mu3_0)];
ste_mu3_0 = [std(All_h2gf(1).eta(1).samples.mu3_0(:,1))/sqrt(length(All_h2gf(1).eta(1).samples.mu3_0)); ...
    ...
    std(All_hgf.hgf_est_srl1_summary.mu3_0)/sqrt(length(All_hgf.hgf_est_srl1_summary.mu3_0));];
...
% Output the table using the annotation command.
annotation(gcf,'Textbox','String',TString,'Interpreter','Tex','FontName',FixedWidth,'Units','Normalized','Position',[0 0 1 1]);
saveas(gcf,['srl1_stats_mu3_0_',configtype],'fig');
print(['srl1_stats_mu3_0_',configtype],'-dtiff');
...
mean_sa2_0 = [mean(All_h2gf(1).eta(1).samples.sa2_0(:,1));mean(All_h2gf(2).eta(1).samples.sa2_0(:,1)); mean(All_h2gf(3).eta(1).samples.sa2_0(:,1)); ...
    ...
    mean(All_hgf.hgf_est_srl1_summary.sa2_0)];
ste_sa2_0 = [std(All_h2gf(1).eta(1).samples.sa2_0(:,1))/sqrt(length(All_h2gf(1).eta(1).samples.sa2_0)); ...
    ...
    std(All_hgf.hgf_est_srl1_summary.sa2_0)/sqrt(length(All_hgf.hgf_est_srl1_summary.sa2_0));];
...
% Output the table using the annotation command.
annotation(gcf,'Textbox','String',TString,'Interpreter','Tex','FontName',FixedWidth,'Units','Normalized','Position',[0 0 1 1]);
saveas(gcf,['srl1_stats_sa2_0_',configtype],'fig');
print(['srl1_stats_sa2_0_',configtype],'-dtiff');
...
mean_sa3_0 = [mean(All_h2gf(1).eta(1).samples.sa3_0(:,1));mean(All_h2gf(2).eta(1).samples.sa3_0(:,1)); mean(All_h2gf(3).eta(1).samples.sa3_0(:,1)); ...
    ...
    mean(All_hgf.hgf_est_srl1_summary.sa3_0)];
ste_sa3_0 = [std(All_h2gf(1).eta(1).samples.sa3_0(:,1))/sqrt(length(All_h2gf(1).eta(1).samples.sa3_0)); ...
    ...
    std(All_hgf.hgf_est_srl1_summary.sa3_0)/sqrt(length(All_hgf.hgf_est_srl1_summary.sa3_0));];
...
% Output the table using the annotation command.
annotation(gcf,'Textbox','String',TString,'Interpreter','Tex','FontName',FixedWidth,'Units','Normalized','Position',[0 0 1 1]);
saveas(gcf,['srl1_stats_sa3_0_',configtype],'fig');
print(['srl1_stats_sa3_0_',configtype],'-dtiff');
...
mean_om3 = [mean(All_h2gf(1).eta(1).samples.om3(:,1));mean(All_h2gf(2).eta(1).samples.om3(:,1)); mean(All_h2gf(3).eta(1).samples.om3(:,1)); ...
    ...
    mean(All_hgf.hgf_est_srl1_summary.om3)];
ste_om3 = [std(All_h2gf(1).eta(1).samples.om3(:,1))/sqrt(length(All_h2gf(1).eta(1).samples.om3)); ...
    ...
    std(All_hgf.hgf_est_srl1_summary.om3)/sqrt(length(All_hgf.hgf_est_srl1_summary.om3));];
...
% Output the table using the annotation command.
annotation(gcf,'Textbox','String',TString,'Interpreter','Tex','FontName',FixedWidth,'Units','Normalized','Position',[0 0 1 1]);
saveas(gcf,['srl1_stats_om3_',configtype],'fig');
print(['srl1_stats_om3_',configtype],'-dtiff');
...
mean_ze = [mean(All_h2gf(1).eta(1).samples.ze(:,1));mean(All_h2gf(2).eta(1).samples.ze(:,1)); mean(All_h2gf(3).eta(1).samples.ze(:,1)); ...
    ...
    mean(All_hgf.hgf_est_srl1_summary.ze)];
ste_ze = [std(All_h2gf(1).eta(1).samples.ze(:,1))/sqrt(length(All_h2gf(1).eta(1).samples.ze)); ...
    ...
    std(All_hgf.hgf_est_srl1_summary.ze)/sqrt(length(All_hgf.hgf_est_srl1_summary.ze));];
...
% Output the table using the annotation command.
annotation(gcf,'Textbox','String',TString,'Interpreter','Tex','FontName',FixedWidth,'Units','Normalized','Position',[0 0 1 1]);
saveas(gcf,['srl1_stats_ze_',configtype],'fig');
print(['srl1_stats_ze_',configtype],'-dtiff');
