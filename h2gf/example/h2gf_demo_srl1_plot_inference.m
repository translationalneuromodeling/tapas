...
title(['nr. of iterations: 1000; ze = ', num2str(h2gf_est1000.summary(subjindex).obs_mean)]); hold on;
...
title(['nr. of iterations: 3000; ze = ', num2str(h2gf_est3000.summary(subjindex).obs_mean)]); hold on;
...
title(['nr. of iterations: 4000; ze = ', num2str(h2gf_est4000.summary(subjindex).obs_mean)]); hold on;
...
title(['nr. of iterations: 5000; ze = ', num2str(h2gf_est5000.summary(subjindex).obs_mean)]); hold on;
linkaxes;
suptitle(configtype);
