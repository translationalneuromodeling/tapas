function tapas_h2gf_binary_plotTraj(r, choice, input, prc_mean, obs_mean)
...
r.u = input;
r.p_prc.p = prc_mean';
r.p_prc.mu_0 = r.p_prc.p(1:3)';
r.p_prc.sa_0 = r.p_prc.p(4:6)';
r.p_prc.rho = r.p_prc.p(7:9)';
r.p_prc.ka = r.p_prc.p(10:11)';
r.p_prc.om = r.p_prc.p(12:14)';
