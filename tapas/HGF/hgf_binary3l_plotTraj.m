function hgf_binary3l_plotTraj(r)
% Plots trajectories estimated by fitModel for the hfg_binary3l perceptual model
% Usage:  est = fitModel(responses, inputs); hgf_binary3l_plotTraj(est);
%
% --------------------------------------------------------------------------------------------------
