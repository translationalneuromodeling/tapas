...
%     [mu,p,ci,stats] = micp_stats(ks,ns,...)
%
% Arguments:
...
% $Id: micp_stats.m 16210 2012-05-31 07:04:48Z bkay $
% -------------------------------------------------------------------------
function [mu,p,ci,stats] = micp_stats(ks,ns,varargin)
    ...
    % Invalid model
    otherwise
        error('invalid model - type ''help micp_stats'' for help');
    end
